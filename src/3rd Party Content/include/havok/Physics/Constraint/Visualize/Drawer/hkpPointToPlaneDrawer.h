...
#ifndef HKP_POINTTOPLANEDRAWER_H
#define HKP_POINTTOPLANEDRAWER_H
...
class hkpPointToPlaneDrawer : public hkpConstraintDrawer
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpPointToPlaneDrawer );

		void drawConstraint(const hkpPointToPlaneConstraintData* constraintData,
			const hkTransform& localToWorldA, const hkTransform& localToWorldB,
			hkDebugDisplayHandler* displayHandler, int id, int tag);
};


#endif	// HKP_POINTTOPLANEDRAWER_H
