...
#ifndef HKP_HINGEDRAWER_H
#define HKP_HINGEDRAWER_H
...
class hkpHingeDrawer : public hkpConstraintDrawer
{
	public:
		...
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpHingeDrawer );

		void drawConstraint(const hkpHingeConstraintData* constraintData,
			const hkTransform& localToWorldA, const hkTransform& localToWorldB,
			hkDebugDisplayHandler* displayHandler, int id, int tag);
};


#endif	// HKP_HINGEDRAWER_H
