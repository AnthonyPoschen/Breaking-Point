...
#ifndef HKP_LIMITEDHINGEDRAWER_H
#define HKP_LIMITEDHINGEDRAWER_H
...
class hkpLimitedHingeDrawer : public hkpConstraintDrawer
{
	public:
		...
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpLimitedHingeDrawer );

		void drawConstraint(const hkpLimitedHingeConstraintData* constraintData,
