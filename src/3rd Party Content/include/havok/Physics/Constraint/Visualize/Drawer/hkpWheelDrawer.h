...
#ifndef HKP_WHEELDRAWER_H
#define HKP_WHEELDRAWER_H
...
class hkpWheelDrawer : public hkpConstraintDrawer
{
	public:
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpWheelDrawer );

		void drawConstraint(const hkpWheelConstraintData* constraintData,
			const hkTransform& localToWorldA, const hkTransform& localToWorldB,
			hkDebugDisplayHandler* displayHandler, int id, int tag);
};


#endif	// HKP_WHEELDRAWER_H
