...
#ifndef HKP_RAGDOLL_LIMITS_DRAWER_H
#define HKP_RAGDOLL_LIMITS_DRAWER_H
...
//
class hkpRagdollLimitsDrawer : public hkpConstraintDrawer
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpRagdollLimitsDrawer );
	
		void drawConstraint(const hkpRagdollLimitsData* constraintData,
...
#endif	// HKP_RAGDOLL_LIMITS_DRAWER_H
