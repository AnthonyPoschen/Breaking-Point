...
#ifndef HKP_PULLEY_DRAWER_H
#define HKP_PULLEY_DRAWER_H
...
class hkpPulleyDrawer : public hkpConstraintDrawer
{
	public:
		...
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpPulleyDrawer );

		void drawConstraint(const hkpPulleyConstraintData* constraintData,
