...
#ifndef HKP_COGWHEELDRAWER_H
#define HKP_COGWHEELDRAWER_H
...
class hkpCogWheelDrawer : public hkpConstraintDrawer
{
	public:
		...
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HKP_MEMORY_CLASS_VDB, hkpCogWheelDrawer );

		void drawConstraint(const hkpCogWheelConstraintData* constraintData,
