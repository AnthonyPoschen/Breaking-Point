...
#ifndef HKP_MOTOR_CONSTRAINT_INFO_H
#define HKP_MOTOR_CONSTRAINT_INFO_H
...
extern "C"
{
	...
	void HK_CALL hk1dAngularVelocityMotorBeginJacobian( hkVector4Parameter directionOfConstraint, const hkpConstraintQueryIn &in, hkp2AngJacobian* HK_RESTRICT jac, hkp1dBilateralConstraintStatus& statusOut );

	// Must call hk1dAngularVelocityMotorBeginJacobian first to build Jacobian in hkpConstraintQueryOut
	void HK_CALL hk1dAngularVelocityMotorCommitJacobian( hkp1dConstraintMotorInfo& info, const hkpConstraintQueryIn &in, hkp2AngJacobian* HK_RESTRICT jac, hkpConstraintQueryOut &out );

	// Build Jacobian element
	void HK_CALL hk1dLinearVelocityMotorBeginJacobian( hkVector4Parameter directionOfConstraint, hkVector4Parameter pivot, const hkpConstraintQueryIn &in, hkp1Lin2AngJacobian* HK_RESTRICT jac, hkp1dBilateralConstraintStatus& statusOut );

	// Must call hk1dLinearVelocityMotorBeginJacobian first to build Jacobian in hkpConstraintQueryOut
	void HK_CALL hk1dLinearVelocityMotorCommitJacobian( hkp1dConstraintMotorInfo& info, const hkpConstraintQueryIn &in, hkp1Lin2AngJacobian* HK_RESTRICT jac, hkpConstraintQueryOut &out );
}
