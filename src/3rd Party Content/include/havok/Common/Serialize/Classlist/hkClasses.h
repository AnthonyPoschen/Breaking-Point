...
#if defined(USING_HAVOK_PHYSICS) 	|| defined(USING_HAVOK_ANIMATION) 	|| defined(USING_HAVOK_BEHAVIOR) 	|| defined(USING_HAVOK_CLOTH) 	|| defined(USING_HAVOK_DESTRUCTION_2012) 	|| defined(USING_HAVOK_AI)
...
#if defined(HK_FEATURE_REFLECTION_PHYSICS_2012)
#  include <Common/Serialize/Classlist/hkPhysics2012Classes.h>
#endif
...
#if defined(HK_FEATURE_REFLECTION_DESTRUCTION_2012)
#  include <Common/Serialize/Classlist/hkDestruction2012Classes.h>
#endif
