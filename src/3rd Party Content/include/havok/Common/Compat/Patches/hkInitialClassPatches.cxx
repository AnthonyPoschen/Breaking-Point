...
#endif // HK_FEATURE_PRODUCT_DESTRUCTION_2012
...
HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkmsCharacterControls", 0)
        HK_PATCH_MEMBER_ADDED("forwardVelocity", TYPE_REAL, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("turnVelocity", TYPE_REAL, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("lookAtTarget", TYPE_VEC_4, HK_NULL, 0)
HK_PATCH_END()

HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkmsApacheHelicopterControls", 0)
        HK_PATCH_MEMBER_ADDED("desiredPosition", TYPE_VEC_4, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("desiredVelocity", TYPE_VEC_4, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("desiredForward", TYPE_VEC_4, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("targetUp", TYPE_VEC_4, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("fade", TYPE_REAL, HK_NULL, 0)
HK_PATCH_END()

HK_PATCH_BEGIN(HK_NULL, HK_CLASS_ADDED, "hkmsTankVehicleControls", 0)
        HK_PATCH_MEMBER_ADDED("trackSpeeds", TYPE_TUPLE_REAL, HK_NULL, 2)
        HK_PATCH_MEMBER_ADDED("turretAzimuth", TYPE_REAL, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("turretElevation", TYPE_REAL, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("useTurretSpeed", TYPE_BYTE, HK_NULL, 0)
        HK_PATCH_MEMBER_ADDED("turretSpeeds", TYPE_TUPLE_REAL, HK_NULL, 2)
HK_PATCH_END()

HK_PATCH_BEGIN("hkmsApacheHelicopterControls", 0, HK_NULL, HK_CLASS_REMOVED)
   HK_PATCH_MEMBER_REMOVED("desiredPosition", TYPE_VEC_4, HK_NULL, 0)
   HK_PATCH_MEMBER_REMOVED("desiredVelocity", TYPE_VEC_4, HK_NULL, 0)
   HK_PATCH_MEMBER_REMOVED("desiredForward", TYPE_VEC_4, HK_NULL, 0)
   HK_PATCH_MEMBER_REMOVED("targetUp", TYPE_VEC_4, HK_NULL, 0)
   HK_PATCH_MEMBER_REMOVED("fade", TYPE_REAL, HK_NULL, 0)
HK_PATCH_END()

HK_PATCH_BEGIN("hkmsTankVehicleControls", 0, HK_NULL, HK_CLASS_REMOVED)
HK_PATCH_MEMBER_REMOVED("trackSpeeds", TYPE_TUPLE_REAL, HK_NULL, 2)
HK_PATCH_MEMBER_REMOVED("turretAzimuth", TYPE_REAL, HK_NULL, 0)
HK_PATCH_MEMBER_REMOVED("turretElevation", TYPE_REAL, HK_NULL, 0)
HK_PATCH_MEMBER_REMOVED("useTurretSpeed", TYPE_BYTE, HK_NULL, 0)
HK_PATCH_MEMBER_REMOVED("turretSpeeds", TYPE_TUPLE_REAL, HK_NULL, 2)
HK_PATCH_END()

#endif // HK_FEATURE_PRODUCT_MILSIM
