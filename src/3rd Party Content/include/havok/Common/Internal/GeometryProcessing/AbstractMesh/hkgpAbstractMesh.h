...
struct hkgpAbstractMeshDefinitions
{
	...
	struct Vertex : public List<VERTEX,BASE>::Item
	{
	...
	struct Triangle : public List<TRIANGLE,BASE>::Item
	{
	...
	struct Tetrahedron : public List<TETREHEDRON,BASE>::Item
	{
...
public:
	...
	/// Check if the mesh does not contain any topological errors.
	...
	/// Check if the mesh contains a reference to a given vertex.
