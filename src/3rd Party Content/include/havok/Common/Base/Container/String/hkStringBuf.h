...
class hkStringBuf
{
	...
	public:
		...
		hkStringBuf& appendJoin(const char* s0, const char* s1=HK_NULL, const char* s2=HK_NULL, const char* s3=HK_NULL, const char* s4=HK_NULL, const char* s5=HK_NULL);
			/// Replace this with the concatenated strings.
		hkStringBuf& setJoin(const char* s0, const char* s1=HK_NULL, const char* s2=HK_NULL, const char* s3=HK_NULL, const char* s4=HK_NULL, const char* s5=HK_NULL);
		...
		hkStringBuf& pathAppend(const char* p0, const char* p1=HK_NULL, const char* p2=HK_NULL);
