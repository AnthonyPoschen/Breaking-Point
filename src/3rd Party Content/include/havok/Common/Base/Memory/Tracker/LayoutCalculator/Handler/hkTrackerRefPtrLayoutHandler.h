...
#ifndef HKBASE_REFPTR_LAYOUT_HANDLER_H
#define HKBASE_REFPTR_LAYOUT_HANDLER_H

#include <Common/Base/Memory/Tracker/LayoutCalculator/hkTrackerLayoutCalculator.h>

class hkTrackerRefPtrLayoutHandler: public hkTrackerLayoutHandler
{
	public: 
...
#endif // HKBASE_REFPTR_LAYOUT_HANDLER_H
