...
#ifndef HKBASE_STRING_MAP_LAYOUT_HANDLER_H
#define HKBASE_STRING_MAP_LAYOUT_HANDLER_H

#include <Common/Base/Memory/Tracker/LayoutCalculator/hkTrackerLayoutCalculator.h>

class hkTrackerStringMapLayoutHandler: public hkTrackerLayoutHandler
{
	public: 
...
#endif // HKBASE_STRING_MAP_LAYOUT_HANDLER_H
