...
#ifndef HK_BufferCompressionInternal_H
#define HK_BufferCompressionInternal_H
...
namespace hkBufferCompression
{
	...
	{
		public:
			HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_BASE, CompressedOutput);
...
#endif // HK_BufferCompressionInternal_H
