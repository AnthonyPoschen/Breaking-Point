...
enum hkJobType
{
	...
	HK_JOB_TYPE_NP_CONSTRAINT_SETUP,
	HK_JOB_TYPE_NP_SOLVER,
	HK_JOB_TYPE_NP_COLLIDE,
...
class hkExternalJobProfiler
{
	public:
		...
		virtual ~hkExternalJobProfiler() {}
		virtual void onStartJob( hkJobType t, hkUint32 m_jobSubType ) = 0;
...
class hkJobQueue
{
	...
	#define MAX_NUM_CPU_THREADS HK_MAX_NUM_THREADS
		...
		// 12 bytes
		typedef hkQueue<JobQueueEntry> Queue;
		//
	...
	public:
		...
		HK_ALIGN16( hkCriticalSection m_criticalSection );
