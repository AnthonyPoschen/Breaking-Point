...
class hkSceneDataToMeshConverter
{
    public:
		...
		enum Space
		{
            ...
            /// the hkxMeshNode
        static hkMeshShape* HK_CALL convert(hkMeshSystem* meshSystem, hkMeshMaterial* overrideMaterial, const class hkxScene* scene, const hkxNode* node, Space space, bool allowMipmaps = true);

			/// Converts a hkxMesh into a hkMeshShape - see previous convert method for details.
		static hkMeshShape* HK_CALL convert(hkMeshSystem* meshSystem, hkMeshMaterial* overrideMaterial, const hkMatrix4& worldTransform, hkxMesh* mesh, bool allowMipmaps = true);
        ...
        static hkMeshVertexBuffer* HK_CALL convertVertexBuffer(hkMeshSystem* meshSystem, hkMatrixDecomposition::Decomposition& decomposition, hkxVertexBuffer* srcVertex);
		...
		static hkMeshMaterial* convert(hkMeshSystem* meshSystem, hkxMaterial* material, bool allowMipmaps = true);
