...
#ifndef HAVOK_FILTER_SCENE_DLL_H
#define HAVOK_FILTER_SCENE_DLL_H

#include <ContentTools/Common/Filters/Common/Filter/hctFilterDll.h>

class hctFilterSceneDll : public hctFilterDll
{
	public:

		hctFilterSceneDll (HMODULE dllModule);
...
#endif // HAVOK_FILTER_SCENE_DLL_H
