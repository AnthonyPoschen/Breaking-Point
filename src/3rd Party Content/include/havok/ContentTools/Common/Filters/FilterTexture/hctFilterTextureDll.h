...
#ifndef HAVOK_FILTER_TEXTURE_DLL_H
#define HAVOK_FILTER_TEXTURE_DLL_H

#include <ContentTools/Common/Filters/Common/Filter/hctFilterDll.h>

class hctFilterTextureDll : public hctFilterDll
{
	public:

		hctFilterTextureDll (HMODULE dllModule);
...
#endif // HAVOK_FILTER_TEXTURE_DLL_H
