...
public:
	...
	public:
		...
		hkBool buildPartialShapeDisplay( const hkpShape* shape, const hkTransform& transform, int branchDepth, 
										 int& numSimpleShapes, hkpShapeContinueData* continueData, 
										 hkArray<hkDisplayGeometry*>& displayGeometries, const hkVector4* scale = HK_NULL );

		// Partial for compound shapes
		hkBool buildPartialShapeDisplay_ShapeContainer( const hkpShapeContainer* shapeContainer, 
														const hkTransform& transform, int branchDepth, 
														int& numSimpleShapes, hkpShapeContinueData* continueData, 
														hkArray<hkDisplayGeometry*>& displayGeometries,
														const hkVector4* scale = HK_NULL );
