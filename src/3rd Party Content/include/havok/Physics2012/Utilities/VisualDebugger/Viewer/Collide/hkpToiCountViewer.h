...
class hkpToiCountViewer : public hkpWorldViewerBase, public hkpContactListener, public hkpWorldPostSimulationListener, protected  hkpEntityListener
{
	public:
	...
	public:
		...
		static void HK_CALL displayTextAtBody( hkDebugDisplayHandler* handler, int tag, hkpRigidBody* body, DisplayPosition pos, const char* text, hkColor::Argb color, hkReal extraDistance = 0.1f, hkBool drawLine = true );
