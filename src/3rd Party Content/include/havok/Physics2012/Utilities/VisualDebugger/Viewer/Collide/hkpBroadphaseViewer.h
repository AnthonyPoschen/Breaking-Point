...
class hkpBroadphaseViewer : public hkpWorldViewerBase, protected hkpWorldPostSimulationListener
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_TOOLS);

			/// Creates a hkpBroadphaseViewer.
		static hkProcess* HK_CALL create(const hkArray<hkProcessContext*>& contexts);

			/// Registers the hkpBroadphaseViewer with the hkProcessFactory.
	...
	protected:
		...
		hkpBroadphaseViewer(const hkArray<hkProcessContext*>& contexts);
		virtual ~hkpBroadphaseViewer();
