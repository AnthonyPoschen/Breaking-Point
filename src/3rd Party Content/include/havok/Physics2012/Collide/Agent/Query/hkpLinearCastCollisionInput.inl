...
hkpLinearCastCollisionInput::hkpLinearCastCollisionInput()
{
...
void hkpLinearCastCollisionInput::set( const hkpProcessCollisionInput& input)
{
	hkpCollisionInput& ip = *this;
	ip = input;
