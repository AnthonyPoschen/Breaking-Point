...
class hkpCollidable : public hkpCdBody
{
	...
	public:
		...
		struct BoundingVolumeData
		{
			...
			public:
				...
				inline BoundingVolumeData( class hkFinishLoadedObjectFlag flag );
	...
	public:
		...
		hkUint8 m_forceCollideOntoPpu;
			...
			// The shape size to DMA to SPU, must be a multiple of 16
	...
	public:
		...
		BoundingVolumeData m_boundingVolumeData; //+nosave
...
#	include <Physics2012/Collide/Agent/Collidable/hkpCollidable.inl>
