...
class hkpMeshWeldingUtility
{
	...
	public:
		...
		static hkResult HK_CALL testWindingConsistency( hkVector4Parameter localVertex0, hkVector4Parameter localEdgeOrtho, hkVector4Parameter localNormal, const hkpTriangleShape* adjacentTriangle, hkVector4Parameter adjacentNormal );
			...
			// Returns the welding info for a triangle given its vertex coordinates and those of its neighboring triangles
		static hkUint16 HK_CALL computeTriangleWeldingInfo(const hkVector4* triangle, const hkVector4* neighbors, 
														   int numNeighbors, hkBool weldOpenEdges = true, 
														   hkReal tolerance = 0.05f);

			// Calculates the intersection between a line and a triangle and returns it expressed as line fractions
		static hkBool HK_CALL clipLineAgainstTriangle(hkVector4Parameter v0, hkVector4Parameter v1, const hkVector4* vertices, const hkVector4& normal, hkReal padding, hkReal& lo, hkReal& hi);
