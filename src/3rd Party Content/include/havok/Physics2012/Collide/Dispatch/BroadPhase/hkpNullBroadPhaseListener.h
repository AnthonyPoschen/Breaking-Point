...
#include <Physics2012/Collide/Dispatch/BroadPhase/hkpBroadPhaseListener.h>
	...
	/// A hkpBroadPhaseListener, which causes an assert if any of it's functions are called
class hkpNullBroadPhaseListener : public hkReferencedObject, public hkpBroadPhaseListener
{
	public:
