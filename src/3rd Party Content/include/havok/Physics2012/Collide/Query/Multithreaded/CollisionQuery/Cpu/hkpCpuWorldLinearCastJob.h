...
#ifndef HK_CPU_COLLIDE_QUERY_WORLD_LINEAR_CAST_JOB_H
#define HK_CPU_COLLIDE_QUERY_WORLD_LINEAR_CAST_JOB_H
...
#endif // HK_CPU_COLLIDE_QUERY_WORLD_LINEAR_CAST_JOB_H
