...
#define HK_CMS_NULL_REF 0xffff
	...
	/// DEPRECATED. This shape has been superseded by hkpBvCompressedMeshShape and will be removed
	/// in future releases.
	///
...
class hkpCompressedMeshShape : public hkpShapeCollection
{
	...
	public:
		...
		HKCD_DECLARE_SHAPE_TYPE(hkcdShapeType::COMPRESSED_MESH);
...
#include <Physics2012/Collide/Shape/Deprecated/CompressedMesh/hkpCompressedMeshShape.inl>
