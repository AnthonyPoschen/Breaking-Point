...
class hkpPhysicsSystem : public hkReferencedObject
{
	public:
		...
		/// Defaults to a shallow clone, sharing as much data as possible.
		/// Motorized constraints will not be independent after a shallow clone
...
#include <Physics2012/Dynamics/World/hkpPhysicsSystem.inl>
