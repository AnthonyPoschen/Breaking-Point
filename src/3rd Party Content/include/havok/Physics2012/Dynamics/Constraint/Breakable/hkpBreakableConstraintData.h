...
class hkpBreakableConstraintData : public hkpConstraintData
{
	public:
		...
		struct Runtime
		{
			...
			hkBool m_isBroken;
			HK_ALIGN(hkReal m_linearVelcityA[3],HK_REAL_SIZE);  
			HK_ALIGN(hkReal m_linearVelcityB[3],HK_REAL_SIZE);
			HK_ALIGN(hkReal m_angularVelcityA[3],HK_REAL_SIZE);
			HK_ALIGN(hkReal m_angularVelcityB[3],HK_REAL_SIZE);
		};
...
#include <Physics2012/Dynamics/Constraint/Breakable/hkpBreakableConstraintData.inl>
