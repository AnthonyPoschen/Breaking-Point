...
#ifndef HKP_CONSTRAINT_INSTANCE_H
#define HKP_CONSTRAINT_INSTANCE_H
...
#if defined(HK_PLATFORM_WIN32) && defined(HK_REAL_IS_DOUBLE)
#	define HKP_MAX_NUMBER_OF_CHAIN_CONSTRAINTS_IN_ISLAND_WHEN_MULTITHREADING 48
#else
#	define HKP_MAX_NUMBER_OF_CHAIN_CONSTRAINTS_IN_ISLAND_WHEN_MULTITHREADING 0
#endif


/// Association between a constraint definition (hkpConstraintData) and two entities (hkpEntity)
...
HK_CLASSALIGN(struct,HK_REAL_ALIGNMENT) hkConstraintInternal
{
	...
	public:
		...
		hkEnum<hkpConstraintInstance::InstanceType,hkUint8> m_constraintType;	// cached instance type to improve cache performance
...
#include <Physics2012/Dynamics/Constraint/hkpConstraintInstance.inl>


#endif // HKP_CONSTRAINT_INSTANCE_H
