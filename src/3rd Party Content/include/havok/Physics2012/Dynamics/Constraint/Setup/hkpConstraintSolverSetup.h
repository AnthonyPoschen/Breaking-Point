...
#ifndef HKP_CONSTRAINT_SOLVER_SETUP_H
#define HKP_CONSTRAINT_SOLVER_SETUP_H
...
struct hkpBuildJacobianTask
{
	...
	struct AtomInfo
	{
		...
		// these indices are not used for buliding Jacobians and replace the above indices for solving, if they're defined
