...
/// Provides methods to create a constraint construction command list (hkpGenericConstraintDataScheme)
/// and use it to initialize a hkpGenericConstraintData object.
