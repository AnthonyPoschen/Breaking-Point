...
struct hkpContactPointConfirmedEvent
{
	...
	hkContactPointId getContactPointId() const;
		...
		/// Gets the DynamicsContactMgr.
		/// \warning This function only works if you are not implementing your own
...
#include <Physics2012/Dynamics/Collide/Deprecated/hkpCollisionEvents.inl>
