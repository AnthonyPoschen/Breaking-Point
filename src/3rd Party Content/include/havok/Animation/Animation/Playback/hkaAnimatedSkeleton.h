...
class hkaAnimatedSkeleton : public hkReferencedObject, protected hkaAnimationControlListener
{
	public:
		...
		virtual void sampleAndCombineAnimations( hkQsTransform* poseLocalSpaceOut, hkReal* floatSlotsOut ) const;
		...
		virtual void sampleAndCombinePartialAnimations( hkQsTransform* poseLocalSpaceOut, hkUint32 maxBones, hkReal* floatSlotsOut, hkUint32 maxFloatSlots ) const;
		...
		virtual void sampleAndCombineSingleBone( hkQsTransform* localSpaceOut, hkInt16 bone ) const;
			...
			/// \param cache Cache provided (if any)
		virtual void sampleAndCombineSingleSlot( hkReal* floatOut, hkInt16 slot ) const;
			...
			/// \param cache Cache provided (if any)
		virtual void sampleAndCombineIndividualBones( hkQsTransform* localSpaceOut, hkInt16* bones, hkUint32 numBones ) const;
			...
			/// \param cache Cache provided (if any)
		virtual void sampleAndCombineIndividualSlots( hkReal* floatOut, hkInt16* slots, hkUint32 numSlots ) const;
	...
	protected:
		...
		virtual void controlDeletedCallback(hkaAnimationControl* control) HK_OVERRIDE;

		void sampleAndCombineInternal( hkQsTransform* poseLocalSpaceOut, hkUint32 maxBones, hkReal* floatSlotsOut, hkUint32 maxFloatSlots, bool partial ) const;
		void sampleAndCombineIndividual( hkUint32 numBones, const hkInt16* individualBones, hkQsTransform* poseLocalSpaceOut, hkUint32 numFloatSlots, const hkInt16* individualSlots, hkReal* floatSlotsOut ) const;
};
