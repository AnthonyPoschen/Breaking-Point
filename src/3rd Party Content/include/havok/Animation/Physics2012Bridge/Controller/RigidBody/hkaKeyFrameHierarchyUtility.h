...
class hkaKeyFrameHierarchyUtility 
{
	public:
		...
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_ANIM_RUNTIME,hkaKeyFrameHierarchyUtility);
		...
		struct Output
		{
			...
			/// Initialize a single WorkElem.
		static void HK_CALL initialize( const hkpRigidBody* rb, WorkElem& workElem );
